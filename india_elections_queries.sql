/*===============================================================
 Q1: INDIA GENERAL ELECTIONS RESULT ANALYSIS 2024
...
/*---------------------------------------------------------------
 Add new column for Party Alliance
---------------------------------------------------------------*/
ALTER TABLE partywise_results 
ADD party_alliance VARCHAR(50);

/*---------------------------------------------------------------
 Update Party Alliance for I.N.D.I.A
---------------------------------------------------------------*/
...
/*---------------------------------------------------------------
 Update Party Alliance for Others
---------------------------------------------------------------*/
UPDATE partywise_results
...
/*===============================================================
 Q2: Which party alliance (NDA, I.N.D.I.A, or OTHER) 
...
/*===============================================================
 Q3: Winning candidate's name, their party name, total votes,
...
/*===============================================================
 Q4: What is the distribution of EVM votes versus postal votes 
...
/*===============================================================
 Q5: Which parties won the most seats in a State, and how many 
 seats did each party win?
===============================================================*/
SELECT 
    p.Party, 
    COUNT(cr.Constituency_ID) AS Seats_Won
...
/*===============================================================
 Q6: Which candidate received the highest number of EVM votes 
...
/*===============================================================
 Q7: Which candidate won and which candidate was the runner-up 
 in each constituency of a State for the 2024 elections?
===============================================================*/
...
/*===============================================================
 Q8: For the state of Maharashtra, show total seats, candidates, 
 parties, total votes (EVM + postal), and vote type breakdown.
===============================================================*/
SELECT 
